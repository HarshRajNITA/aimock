...
//       }
//     } catch (error) {
//       console.warn("Speech recognition already stopped or not initialized:", error);
//     }
//   };
...
//     // Wait briefly before restarting speech recognition
//     setTimeout(() => {
//       safeStartRecording();
//     }, 300);
//   };
...
//       setLoading(false);
//       toast.error("Error", {
//         description: "You need to record and generate feedback first.",
//       });
//       return;
//     }
...
//       .map((result) => result.transcript)
//       .join(" ");
//       console.log( "me print kar rha hu",combineTranscripts)
